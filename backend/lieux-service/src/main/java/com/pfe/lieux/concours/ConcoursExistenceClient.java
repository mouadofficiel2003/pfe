...
/**
 * Vérifie auprès du service concours qu'un identifiant de concours existe (pour {@code salle.concours_id}).
 */
@Component
public class ConcoursExistenceClient {
    ...
    public List<Long> listConcoursIdsByCentre(Long centreId, String authorizationHeader) {
        if (centreId == null
        ...
        try {
            ...
            List<Long> ids = new ArrayList<>(body.length);
    ...
    public void assertConcoursExists(Long concoursId, String authorizationHeader) {
        if (concoursId == null) {
            return;
        }
